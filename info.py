...
API_ID = int(environ.get('API_ID', '17822592'))
API_HASH = environ.get('API_HASH', 'a20b3dbbe07ed695563b4609a3e62012')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://telegra.ph/file/0151dc084b62cb01b209d.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1068599353').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '578811855').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002484007157'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002359871576').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002182833797') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002482437551')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kumarigani143:kumargani143@cluster0.jucw6.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'KAB_Movies_Bot') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/KAB_Movies')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KAB_Movies')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'KAB_Movies') # Support Chat Link Without https:// or @
